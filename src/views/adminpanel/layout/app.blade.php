...
<head lang="en">
	...
	<link href="{{url('public/backend/img/favicon.144x144.png')}}" rel="apple-touch-icon" type="image/png" sizes="144x144">
	<link href="{{url('public/backend/img/favicon.144x144.png')}}" rel="apple-touch-icon" type="image/png" sizes="114x114">
	<link href="{{url('public/backend/img/favicon.72x72.png')}}" rel="apple-touch-icon" type="image/png" sizes="72x72">
	<link href="{{url('public/backend/img/favicon.57x57.png')}}" rel="apple-touch-icon" type="image/png">
	<link href="{{url('public/backend/img/favicon.png')}}" rel="icon" type="image/png">
	<link href="{{url('public/backend/img/favicon.ico')}}" rel="shortcut icon">
	...
	<![endif]-->
	{!! Html::style(url('public/backend/css/bootstrap.css')) !!}
	{!! Html::style(url('public/backend/css/font-awesome.min.css')) !!}
	{!! Html::style(url('public/backend/css/oldbootstrap.min.css')) !!}
	{!! Html::style(url('public/backend/css/fileinput.css')) !!}
	{!! Html::style(url('public/backend/css/main.css')) !!}
	{!! Html::style(url('public/backend/css/customback.css')) !!}
	{!! Html::style(url('public/backend/css/sweetalert.css')) !!}
	{!! Html::style(url('public/backend/css/paginate.css')) !!}
	{!! Html::style(url('public/backend/css/lightbox.css')) !!}
	{!! Html::style(url('public/backend/css/select2.css')) !!}
    @yield('header')
</head>
	...
	<header class="site-header">
	    <div class="container-fluid">
	        ...
	        <a href="#" class="site-logo">
	            <img class="hidden-md-down" src="{{url('public/backend/img/logo-2.png')}}" alt="">
	            <img class="hidden-lg-up" src="{{url('public/backend/img/logo-2-mob.png')}}" alt="">
	        </a>
	                ...
	                <div class="site-header-shown">
	                        ...
	                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-notif" aria-labelledby="dd-notification">
	                            ...
	                            <div class="dropdown-menu-notif-list">
	                                <div class="dropdown-menu-notif-item">
	                                    <div class="photo">
	                                        <img src="{{url('public/backend/img/photo-64-1.jpg')}}" alt="">
	                                    </div>
	                                    <div class="dot"></div>
	                                ...
	                                <div class="dropdown-menu-notif-item">
	                                    <div class="photo">
	                                        <img src="{{url('public/backend/img/photo-64-2.jpg')}}" alt="">
	                                    </div>
	                                    <div class="dot"></div>
	                                ...
	                                <div class="dropdown-menu-notif-item">
	                                    <div class="photo">
	                                        <img src="{{url('public/backend/img/photo-64-3.jpg')}}" alt="">
	                                    </div>
	                                    <div class="dot"></div>
	                                ...
	                                <div class="dropdown-menu-notif-item">
	                                    <div class="photo">
	                                        <img src="{{url('public/backend/img/photo-64-4.jpg')}}" alt="">
	                                    </div>
	                                ...
	                                <div class="tab-pane active" id="tab-incoming" role="tabpanel">
	                                    <div class="dropdown-menu-messages-list">
	                                        <a href="#" class="mess-item">
	                                            <span class="avatar-preview avatar-preview-32"><img src="{{url('public/backend/img/photo-64-2.jpg')}}" alt=""></span>
	                                            <span class="mess-item-name">Tim Collins</span>
	                                            <span class="mess-item-txt">Morgan was bothering about something!</span>
	                                        </a>
	                                        <a href="#" class="mess-item">
	                                            <span class="avatar-preview avatar-preview-32"><img src="{{url('public/backend/img/avatar-2-64.png')}}" alt=""></span>
	                    ...
	                    <div class="dropdown user-menu">
	                        <button class="dropdown-toggle" id="dd-user-menu" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
	                        	@if($image_user)
		                        	@foreach($image_user as $imguser)
		                            <img src="{{url(imagesdirectory().Storage::disk('local')->url($imguser->picture))}}" alt="">
		                            @endforeach
	                            @endif
	                        </button>
	                    ...
	                    <div class="site-header-collapsed-in">
	                        ...
	                        <div class="dropdown">
	                            ...
	                            <div class="dropdown-menu" aria-labelledby="dd-header-add">
	                                <a class="dropdown-item" href="{{Route('create_registration')}}">Add User</a>
	                            </div>
	                        </div>
...
{!! Html::script(url('public/backend/js/jquery.min.js')) !!}
{!! Html::script(url('public/backend/js/popper.min.js')) !!}
{!! Html::script(url('public/backend/js/bootstrap.min.js')) !!}
{!! Html::script(url('public/backend/js/fileinput.js')) !!}
{!! Html::script(url('public/backend/js/plugins.js')) !!}
{!! Html::script(url('public/backend/js/sweetalert.min.js')) !!}
{!! Html::script(url('public/backend/js/lightbox.js')) !!}
{!! Html::script(url('public/backend/js/app.js')) !!}
{!! Html::script(url('public/backend/js/select2.js')) !!}
@yield('footer')
	@if (notify()->ready())
	    <script>
	        swal({
